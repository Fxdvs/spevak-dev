...
export const PulseBeams = () => {
  return (
    <div className="flex h-[40rem] w-full relative items-center justify-center antialiased bg-transaprent overflow-hidden">
      <button className="bg-neutral-950 w-[320px] z-40 h-[120px] no-underline group cursor-pointer relative shadow-2xl shadow-neutral-950 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block "
      onClick={() => location.href="mailto:work@spevak.dev"}
      >
        ...
        <div className="relative flex justify-center w-[320px] text-center space-x-2 h-[120px] items-center z-10 rounded-full bg-neutral-950 py-0.5 px-4">
          <span className="text-3xl inline-block bg-clip-text text-transparent bg-gradient-to-r from-neutral-500 to-white">
            work@spevak.dev
          </span>
        </div>
      </button>
